...
class PlayerModel {
  ...
  // Placeholder ? akan diganti dengan nilai dari array parameter kedua(id) saat query dijalankan.
  ...
  static async getById(id: number): Promise<Player | undefined> {
    ...
    // Array [id] akan menggantikan tanda ? pada query.
  ...
  // Parameter data berisi data Player tanpa id karena id dibuat otomatis oleh database.
  ...
  // Menerima id dan data baru (tanpa id). Mengembalikan jumlah baris yang terpengaruh (affectedRows).
